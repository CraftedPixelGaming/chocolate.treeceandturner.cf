...
function adjustFullScreenSize() {
	$(".fullSizeWindow .wincontent").css("width", (window.innerWidth - 1014));
	$(".fullSizeWindow .wincontent").css("height", (window.innerHeight - 624));
}
...
$(document).ready(function(){
	$(".window").each(function() {      		// window template
		...
		$(this).prepend('<div class="windowHeader"><strong>' + $(this).attr("data-title") + '</strong><span title="Minimize" class="winminimize"><span></span></span></span><span title="Close" class="winclose">x</span></div>');
	});
